...
CFLAGS += -I. -DWLR_USE_UNSTABLE -D_POSIX_C_SOURCE=200809L -Wno-declaration-after-statement -Wno-unused-label -Wno-error=implicit-function-declaration $(XWAYLAND) -DPREFIX=\"$(PREFIX)\" -DREPL_SOCKET_PATH=\"$(REPL_SOCKET_PATH)\"
